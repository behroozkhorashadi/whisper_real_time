...
class WhisperRealtimeTranscript:
    def __init__(self,
                 model_type: str,
                 record_timeout: int,
                 energy_threshold: int,
                 phrase_timeout: int,
                 stop_phrase: str = "stop transcription"):
    ...
    def start_transcript(self):
        ...
        # threshold dramtically to a point where the SpeechRecognizer never
        # stops recording.
        ...
        # We could do this manually but SpeechRecognizer provides a nice
        # helper.
        recorder.listen_in_background(
            source, record_callback, phrase_time_limit=self.record_timeout)
        ...
        while True:
            try:
                ...
                if not data_queue.empty():
                    ...
                    # the phrase complete.
                    # Clear the current working audio buffer to start over with
                    # the new data.
                    if (phrase_time and
                            now - phrase_time >
                    ...
                    for line in transcription:
                        print(line)
                        if "end transcription" in line.lower():
